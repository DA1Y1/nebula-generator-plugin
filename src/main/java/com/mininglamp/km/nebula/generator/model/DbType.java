...
public enum DbType {
    ...
    NEBULA_11("com.vesoft.nebula.jdbc.GraphDriver", "jdbc:graph://%s:%s/%s?characterEncoding=utf8", ""),
    NEBULA("com.vesoft.nebula.jdbc.GraphDriver", "jdbc:nebula://%s:%s/%s?characterEncoding=utf8", ""),
    ;
